...
class RecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recording" do
    assert_difference('Recording.count') do
      post recordings_url, params: { recording: { description: @recording.description, name: @recording.name, recording: @recording.recording } }
    end
  ...
  test "should update recording" do
    patch recording_url(@recording), params: { recording: { description: @recording.description, name: @recording.name, recording: @recording.recording } }
